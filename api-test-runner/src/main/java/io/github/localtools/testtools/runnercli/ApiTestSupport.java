...
public abstract class ApiTestSupport {
    ...
    /** Case-owned JSON body stored in test-workspace/cases/{caseName}/fixtures. */
    ...
    private JsonNode resolvedJson(String environmentName, Path path, Map<String, ?> overrides) {
        ...
        return new VariableResolver(workspace().jsonMapper()).resolve(workspace().jsonFile(path), values);
    }
