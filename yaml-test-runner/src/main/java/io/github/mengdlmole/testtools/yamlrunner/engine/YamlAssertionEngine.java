...
import io.github.mengdlmole.testtools.yamlrunner.result.AssertionResult;
import io.github.mengdlmole.testtools.yamlrunner.model.YamlAssertionDefinition;

import java.util.Objects;

public final class YamlAssertionEngine {
    private final ObjectMapper mapper;

    public YamlAssertionEngine(ObjectMapper mapper) { this.mapper = mapper; }

    public AssertionResult evaluate(YamlAssertionDefinition definition, ResponseSnapshot response) {
        try {
